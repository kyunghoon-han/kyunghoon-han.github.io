...
const ICONS = {
  ...
  pdf: svg(`<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32' shape-rendering='crispEdges'><polygon points='6,3 22,3 28,9 28,29 6,29' fill='#fff' stroke='#000'/><polyline points='22,3 22,9 28,9' fill='none' stroke='#000'/><rect x='7' y='17' width='18' height='8' fill='#c0212d'/><text x='16' y='23' text-anchor='middle' font-family='Nanum Gothic,sans-serif' font-size='6' font-weight='bold' fill='#fff'>PDF</text></svg>`),
  md: svg(`<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32' shape-rendering='crispEdges'><polygon points='6,3 22,3 28,9 28,29 6,29' fill='#fff' stroke='#000'/><polyline points='22,3 22,9 28,9' fill='none' stroke='#000'/><line x1='9' y1='14' x2='25' y2='14' stroke='#888'/><line x1='9' y1='17' x2='22' y2='17' stroke='#888'/><rect x='7' y='21' width='18' height='6' fill='#1f6feb'/><text x='16' y='25.6' text-anchor='middle' font-family='Nanum Gothic,sans-serif' font-size='5' font-weight='bold' fill='#fff'>MD</text></svg>`),
  linkedin: svg(`<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'><rect width='32' height='32' rx='3' fill='#0a66c2'/><text x='16' y='23' font-family='Nanum Gothic,sans-serif' font-size='18' font-weight='bold' fill='#fff' text-anchor='middle'>in</text></svg>`),
